...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [2] = LAYOUT_split_3x5_2(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PPLS, KC_7, KC_8, KC_9, KC_PMNS, KC_LSFT, KC_LCTL, KC_LGUI, KC_LALT, KC_NO, KC_PAST, KC_4, KC_5, KC_6, KC_SLSH, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PEQL, KC_1, KC_2, KC_3, KC_NO, KC_NO, KC_NO, KC_PDOT, KC_0),
